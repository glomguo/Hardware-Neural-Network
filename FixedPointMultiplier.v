...
module FixedPointMultiplier (
  ...
  input [2:0] PixelPort, // sfix10_En0
  output [18:0] Output_syn // sfix26_En18
//@
);
//@
...
assign Output_syn = N_1;
  ...
  begin: Multiplier_25b_18f_block
    wire signed [21:0] tmpOut;
    wire signed [2:0] tmpin1;
    wire signed [18:0] tmpin2;
    wire signed [2:0] tmpin1_dly;
    ...
    synDelayWithEnable #( .bitwidth(3), .preferRAMImpl(2), .delaylength(1) ) multInp1_block ( .clk(clk), .en(GlobalEnable1), .grst(GlobalResetSel), .rst(1'b0), .inp(tmpin1), .outp(tmpin1_dly) );
